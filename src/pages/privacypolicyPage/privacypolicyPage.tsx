    ...
    >
      <SafeAreaView>
        ...
        <View style={{ width: DEVICE_WIDTH - 32, alignSelf: "center", marginBottom:60 }}>
          ...
          <Text
            style={{ fontWeight: "bold", fontSize: theme.FONT_SIZE_MEDIUM, marginBottom: 5 }}
          >
            一、隱私權保護政策的適用範圍
          </Text>
          <Text style={{ marginBottom: 25 }}>
          ...
          <View style={{flexDirection: 'row'}}>
            <Text>&#8226; </Text>
            <Text style={{lineHeight: 20, flex: 1}}>法律明文規定。</Text> 
          </View>
          <View style={{flexDirection: 'row'}}>
            <Text>&#8226; </Text>
            <Text style={{lineHeight: 20, flex: 1}}>為免除您生命、身體、自由或財產上之危險。</Text>
          </View>
          <View style={{flexDirection: 'row'}}>
            <Text>&#8226; </Text>
            <Text style={{lineHeight: 20, flex: 1}}>與公務機關或學術研究機構合作，基於公共利益為統計或學術研究而有必要，且資料經過提供者處理或搜集著依其揭露方式無從識別特定之當事人。</Text>
          </View>
          <View style={{flexDirection: 'row'}}>
            <Text>&#8226; </Text>
            <Text style={{lineHeight: 20, flex: 1}}>當您在網站的行為，違反服務條款或可能損害或妨礙網站與其他使用者權益或導致任何人遭受損害時，經網站管理單位研析揭露您的個人資料是為了辨識、聯絡或採取法律行動所必要者。</Text>
          </View>
          <View style={{flexDirection: 'row'}}>
            <Text>&#8226; </Text>
            <Text style={{lineHeight: 20, flex: 1}}>有利於您的權益。</Text>
          </View>
          <View style={{flexDirection: 'row', marginBottom: 25}}>
            <Text>&#8226; </Text>
            <Text style={{lineHeight: 20, flex: 1}}>本網站委託廠商協助蒐集、處理或利用您的個人資料，將對委外廠商或個人善盡監督管理之責。</Text>
          </View>
          <Text
            style={{ fontWeight: "bold", fontSize: theme.FONT_SIZE_MEDIUM, marginBottom: 5 }}
          >
          ...
          <View style={{flexDirection: 'row'}}>
            <Text>&#8226; </Text>
            <Text style={{lineHeight: 20, flex: 1}}>English4TW僅保留註冊時輸入的姓名與電子郵件以提供帳號註冊/登入使用。</Text> 
          </View>
          <View style={{flexDirection: 'row'}}>
            <Text>&#8226; </Text>
            <Text style={{lineHeight: 20, flex: 1}}>如您使用Facebook登入功能，透過Facebook取得之姓名與電子郵件僅供帳號註冊/登入目的使用。</Text> 
          </View>
          <View style={{flexDirection: 'row'}}>
            <Text>&#8226; </Text>
            <Text style={{lineHeight: 20, flex: 1}}>網站並無搜集或使用其他個人資料或網站使用紀錄/足跡。</Text> 
          </View>
          <View style={{flexDirection: 'row'}}>
            <Text>&#8226; </Text>
            <Text style={{marginBottom: 25, lineHeight: 20, flex: 1}}>您的帳號與資料可透過帳號個人資料頁面進行刪除。</Text> 
          </View>
          <Text
            style={{ fontWeight: "bold", fontSize: theme.FONT_SIZE_MEDIUM, marginBottom: 5 }}
          >
