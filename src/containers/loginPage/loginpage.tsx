                ...
                <View style={[styles.sheet]}>
                    <Animated.View style={[styles.popup, slideUp]}>
                        ...
                        <View style={styles.sectionContainer}>
                            <Image source={images.icons.launch_icon} style={{ width: 85, height: 85 }} />
                            <Text style={{ fontSize: 12, color: theme.FONT_COLOR_GRAY, textAlign: 'center', marginTop: 30, marginBottom: 15 }}>
                                為使本產品達到最佳使用體驗, 建議用戶使用上方Facebook登入綁定會員帳戶.
                            </Text>
                            <Button
                                title="使用 Facebook 帳號登入"
                                image={images.icons.facebook_icon}
                                customStyle={{ flexDirection: 'row', borderRadius: 25, height: 50, width: DEVICE_WIDTH - 40 }}
                            ...
                            <View style={{ flexDirection: 'row' }}>
                                <Text style={{ color: theme.FONT_COLOR_GRAY, fontSize: theme.FONT_SIZE_MEDIUM }}>
                                    還沒創建帳戶嗎？
                                </Text>
                                <TouchableWithoutFeedback onPress={() => onCreateAccount()}>
                                    <Text style={{ color: theme.FONT_COLOR_GRAY, fontSize: theme.FONT_SIZE_MEDIUM, fontWeight: 'bold' }}>點擊創建新帳戶</Text>
                                </TouchableWithoutFeedback>
                            </View>
                        </View>
                    </Animated.View>
